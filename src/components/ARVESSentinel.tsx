...
export const ARVESSentinel: React.FC<ARVESSentinelProps> = ({
  isActive,
  onToggleActive,
  interval,
  onIntervalChange,
  ...
  const [autoSpeak, setAutoSpeak] = useState(() => {
    return localStorage.getItem('arves_sentinel_autospeak') === 'true';
  });

  const handleAutoSpeakToggle = (val: boolean) => {
    setAutoSpeak(val);
    localStorage.setItem('arves_sentinel_autospeak', String(val));
  };
